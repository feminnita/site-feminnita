      ...
      <section className="py-12 bg-white">
        <div className="max-w-[1200px] mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {lancamentos.map((p) => <ProductCard key={p.id} product={p} />)}
          </div>
          <div className="text-center mt-8">
            <Link href="/colecao/lancamentos" className="inline-block border border-gray-800 text-[11px] tracking-widest uppercase px-10 py-3 hover:bg-gray-800 hover:text-white transition-colors">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-[1200px] mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {categorias.map((cat) => (
              <Link key={cat.href} href={cat.href} className="group relative overflow-hidden flex items-end"
        ...
        <section className="py-12 border-t border-gray-100">
          <div className="max-w-[1200px] mx-auto px-4">
            <div className="flex items-center justify-between mb-10">
              ...
              <span className="text-[12px] font-medium tracking-wide" style={{ color: "#8C2F39" }}>até 50% OFF</span>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
