...
export const metadata: Metadata = {
  title: "Feminnita | Moda Fitness Feminina - Atacado e Varejo",
  description: "Moda fitness feminina com design inovador. Tops, leggings, shorts e muito mais. Atacado e varejo com entrega para todo Brasil.",
};
  ...
  return (
    <html lang="pt-BR" className={`${geistSans.variable} ${geistMono.variable}`}>
      <head>
        ...
        <meta name="author" content="Feminnita" />
        <meta property="og:title" content="Feminnita | Moda Fitness Feminina" />
