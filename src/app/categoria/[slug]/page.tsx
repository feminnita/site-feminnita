    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-[1400px] mx-auto px-6 py-24 text-center">
          <p className="text-gray-400 text-sm tracking-widest uppercase mb-6">Ops, não encontrado</p>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[1400px] mx-auto px-6 pt-10 pb-4">
        <h1 className="text-[13px] font-light tracking-[0.3em] uppercase text-gray-700 text-center">
          {category.name}
        </h1>
        <p className="text-center text-[11px] text-gray-400 mt-1">{products.length} produtos</p>
      </div>

      {/* Barra de controles — igual Ange */}
      <div className="border-t border-b border-gray-100">
        <div className="max-w-[1400px] mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              onClick={() => setCols(3)}
              className={`transition-opacity ${cols === 3 ? "opacity-100" : "opacity-30"}`}
              title="3 colunas"
            >
            ...
            <button
              onClick={() => setCols(4)}
              className={`transition-opacity ${cols === 4 ? "opacity-100" : "opacity-30"}`}
              title="4 colunas"
            >
